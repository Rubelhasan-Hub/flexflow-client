...
export default function ForumPage() {
    const [postsData, setPostsData] = useState({ posts: [], totalPages: 1, currentPage: 1 });
        ...
        <div className="min-h-screen bg-[#070b12] text-white py-16 px-6 md:px-20">
            ...
            <div className="flex justify-center items-center gap-6 mt-16">
                <button
                    ...
                    className="flex items-center gap-2 bg-green-700 px-5 py-2 rounded-lg font-bold text-sm hover:bg-green-500 disabled:bg-gray-700 disabled:cursor-not-allowed"
                >
